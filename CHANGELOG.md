...
- Added Stress Scenario Suite plan file: `docs/examples/experiment_plan_stress.json`.
...
- Batch Markdown reports now include global and per-profile stress summaries for non-full completion, timeout pressure, privacy-utility tradeoffs, reward, and fairness.
- Data generation supports named stress profiles with separate capacity, deadline, privacy-noise, reward-skew, and heterogeneous-speed pressure while preserving the legacy default profile.
